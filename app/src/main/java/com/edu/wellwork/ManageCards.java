...
import com.edu.wellwork.Models.CardDetails;
...
public class ManageCards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(v -> {
            Intent intent = new Intent(ManageCards.this, AddCard.class);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                MyAdapter adapter = new MyAdapter(ManageCards.this, R.layout.custom_card_details, (ArrayList<CardDetails>) user);
    ...
    class MyAdapter extends ArrayAdapter<CardDetails> {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                holder.button3 = (Button) view.findViewById(R.id.pay);
            ...
            holder.button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final String idd = user.get(position).getCardNumber();
                    final DatabaseReference reference = FirebaseDatabase.getInstance().getReference("CardDetils").child(idd);
                    ...
                    buttonupdate.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (Ownername.isEmpty()) {
                                ...
                                Toast.makeText(ManageCards.this, "Updated successfully", Toast.LENGTH_SHORT).show();
            ...
            holder.button3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(ManageCards.this, "Payment Successful", Toast.LENGTH_SHORT).show();
                }
            });
